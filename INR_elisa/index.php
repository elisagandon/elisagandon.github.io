...
<html lang="fr">
  <head>
        ...
        <!-- lien vers mon reset.css -->
    <link rel="stylesheet" type="text/css" href="style/reset.css">

    <!-- lien vers mon style.css -->
...
<header>
    ...
    <p id="header">Cette page regroupe mes différentes réferences de projets de design et de livres en lien avec mon sujet de mémoire "Graphisme et lien social</p>
